  ...
  return (
    <dialog id={alarmId} className="modal">
      <div className="modal-box" style={{backgroundColor:'#F7F6E4'}}>
        ...
        <button class="btn btn-neutral btn-sm rounded-full mb-2 ms-12">코드 추가</button>
        <div className="flex">
          <label className="font-bold me-1 text-base"htmlFor="code">코드</label>
          <CodeMirror className='w-11/12 text-sm' height="250px" id="code"/>
        </div>
        <div className="flex justify-end">
