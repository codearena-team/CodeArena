...
import Introduce from '../../images/main/MainPage4/Introduce.gif';
import We from '../../images/main/MainPage4/We.gif';

export default function MainPage4({ Page4Ref }) {
  return (
    <div ref={Page4Ref} className="flex items-center justify-center h-screen relative">
        {/* 회색 선 - 위쪽 */}
