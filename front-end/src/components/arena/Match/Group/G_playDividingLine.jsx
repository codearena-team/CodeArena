...
export default function G_playDividingLine({ onDividerMoving }) {
    ...
    if (isDragging) {
      ...
      if (newPosition >= 35 && newPosition <= 65) {
        ...
        requestAnimationFrame(() => {
          ...
          onDividerMoving(targetPosition);
  ...
  return (
    <div>
      ...
      <div
        className={`vertical-Lobbydivider-play ${isHovered || isDragging ? 'hovered' : ''}`}
