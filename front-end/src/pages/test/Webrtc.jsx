...
const APPLICATION_SERVER_URL = process.env.NODE_ENV === 'production' ? '' : 'https://i10d211.p.ssafy.io/';
...
class Webrtc extends Component {
  constructor(props) {
    ...
    this.state = {
      customSessionId: 'qweasdzxc',
      myUserName: '유저이름' + Math.floor(Math.random() * 100),
      session: undefined,
      publisher: undefined,
      subscribers: [],
    };
